...
We wish to study the thermal evolution of a plasma in Chapter~\ref{chap:chromosphere}. For this we must transform the energy equation (Equation~\ref{eq:energyequation}) to a form that evolves thermal pressure. We can do this by taking the dot product of the momentum equation and subtracting it from the energy equation. This leaves the energy equation with the thermal energy equation:
...
And in a two-fluid approach we may define current along with the same assumptions:
\begin{equation}
...
To close our set of equations we need a way to evolve the magnetic fields. For this we can use the law of induction (Equation~\ref{eq:lawofinduction}) with the GOL (Equation~\ref{eq:gomlowfreq}).
...
This also gives the opportunity to have as many terms in conservative forms as we can.

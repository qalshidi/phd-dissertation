...
The above is the Euler equation for a wave propogating at constant speed $v$ using a forward difference method, also called an upwind scheme. The Von Neumann method takes a fourier analysis to the error waves generated due to discretization. We say that by using the Taylor series the discretization should have this {\it exact\/} solution.
...
Or the stability requirement, also known as the Courant-Friedrich Levy condition:
